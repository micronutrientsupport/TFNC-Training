...
<embed src= "TFNC-Week1.html#toolbar=1" width="800" height="500">


<embed src="data/RGitHub.pdf" type="application/pdf" width="800" height="500"> 


<video data-autoplay src="http://clips.vorwaerts-gmbh.de/big_buck_bunny.mp4#toolbar=1"></video>
...
--  Downloading and Installing R, RStudio and Git
-   Exercise 2 (Optional) - Linking GitHub and R

## Configuring Git from RStduio (Exercise 2)
